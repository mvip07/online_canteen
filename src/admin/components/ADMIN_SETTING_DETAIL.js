...
function ADMIN_SETTING_DETAIL({ data, SET_MENU }) {
    return (
        <COMPONENT className="SETTING__COMPONENT">
            <NavLink className="setting-link" to="" onClick={() => CHANGE(data?.title, "admin", SET_MENU)}>
...
export default ADMIN_SETTING_DETAIL
